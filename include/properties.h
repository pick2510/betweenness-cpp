...
#include <map>
#include <vector>
void write_global_state(std::vector<aggr_result_t> &results,
...
void initialize_output_files(const Config & runningConf, decom_vec_storage_t decomp_str, const boost::filesystem::path & system_path, const boost::filesystem::path & cellstr_path, aggr_result_t & res);
